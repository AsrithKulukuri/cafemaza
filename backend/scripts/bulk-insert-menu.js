...
const MenuItem = require('../src/models/MenuItem'); // Adjust path if needed
...
const menuItems = [
    ...
    { category: "Tandoori Starters (Veg & Non-Veg)", name: "Tandoori Chicken", price: 0 },
...
async function main() {
    await mongoose.connect('mongodb://127.0.0.1:5678/cafe_maza');
    await MenuItem.deleteMany({}); // Optional: clear old menu
