        ...
        <div className="grid min-h-screen md:grid-cols-2">
            ...
            <div className="flex items-center justify-center bg-[#0B0B0B] p-4 sm:p-6 py-12">
                <div className="glass-card w-full max-w-md rounded-2xl sm:rounded-3xl border border-[#CFAF63]/25 p-5 sm:p-7">
                    <p className="text-xs sm:text-sm uppercase tracking-[0.2em] text-[#CFAF63]">Login</p>
                    <h1 className="mt-1.5 font-(--font-heading) text-2xl sm:text-4xl text-[#F5F5F5]">Phone OTP Login</h1>
                    ...
                    <p className="mt-4 text-xs sm:text-sm text-[#F5F5F5]/70">
                        New user?{" "}
                        <Link href={`/signup?next=${encodeURIComponent(nextPath)}`} className="text-[#CFAF63] hover:text-[#FF6A00] font-medium">
                            Create account
                        </Link>
                    </p>
